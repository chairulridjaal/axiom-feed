fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if !has_protoc {
        ...
        let stub = r#"#[allow(dead_code, clippy::all)]
            ...
            pub struct WebsocketWrapMessageChannel { #[prost(oneof="websocket_wrap_message_channel::MessageChannel", tags="1,2,6,7,8,9,10")] pub message_channel: Option<websocket_wrap_message_channel::MessageChannel> }
            pub mod websocket_wrap_message_channel { #[derive(Clone, PartialEq, ::prost::Oneof)] pub enum MessageChannel { #[prost(message, tag="1")] RunningTrade(super::RunningTrade), #[prost(message, tag="2")] Ping(super::PingResponse), #[prost(message, tag="6")] OrderbookBody(super::OrderBookBody), #[prost(message, tag="7")] Error(super::Error), #[prost(message, tag="8")] RunningTradeBatch(super::RunningTradeBatch), #[prost(message, tag="9")] Liveprice(super::LivePrice), #[prost(message, tag="10")] Orderbook(super::Orderbook) } }
            #[derive(Clone, PartialEq, ::prost::Message)] pub struct RunningTrade { #[prost(string, tag="2")] pub stock: String, #[prost(double, tag="3")] pub price: f64, #[prost(double, tag="4")] pub volume: f64, #[prost(enumeration="TradeType", tag="5")] pub action: i32, #[prost(bool, tag="6")] pub is_global: bool, #[prost(message, optional, tag="7")] pub time: Option<::prost_types::Timestamp>, #[prost(message, optional, tag="8")] pub change: Option<Change>, #[prost(int64, tag="9")] pub trade_number: i64, #[prost(enumeration="BoardType", tag="10")] pub market_board: i32, #[prost(double, tag="11")] pub value: f64, #[prost(message, optional, tag="1")] pub websocket_time: Option<::prost_types::Timestamp> }
            #[derive(Clone, PartialEq, ::prost::Message)] pub struct RunningTradeBatch { #[prost(message, repeated, tag="1")] pub batch: Vec<RunningTrade> }
            #[derive(Clone, PartialEq, ::prost::Message)] pub struct Error { #[prost(enumeration="ErrorCode", tag="1")] pub code: i32, #[prost(string, tag="2")] pub message: String }
            #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)] #[repr(i32)] pub enum ErrorCode { Unspecified = 0, BadRequest = 400, Unauthorized = 401 }
            #[derive(Clone, PartialEq, ::prost::Message)] pub struct LivePrice { #[prost(string, tag="1")] pub stock_code: String, #[prost(double, tag="2")] pub lastprice: f64, #[prost(double, tag="3")] pub volume: f64, #[prost(double, tag="4")] pub high: f64, #[prost(double, tag="5")] pub low: f64, #[prost(double, tag="6")] pub open: f64, #[prost(double, tag="7")] pub frequency: f64, #[prost(double, tag="8")] pub frg_buy: f64, #[prost(double, tag="9")] pub frg_sell: f64, #[prost(double, tag="10")] pub average: f64, #[prost(string, tag="11")] pub date: String, #[prost(double, tag="12")] pub close: f64, #[prost(double, tag="13")] pub prev: f64, #[prost(double, tag="14")] pub value: f64, #[prost(message, optional, tag="15")] pub change: Option<Change>, #[prost(string, tag="16")] pub order_verb: String, #[prost(int64, tag="17")] pub quantity: i64, #[prost(bool, tag="18")] pub is_index: bool, #[prost(int64, tag="19")] pub sequence_number: i64, #[prost(int64, tag="20")] pub order_book_id: i64, #[prost(int64, tag="21")] pub order_number: i64, #[prost(int64, tag="22")] pub match_number: i64, #[prost(int32, tag="23")] pub board_flag: i32, #[prost(string, tag="26")] pub match_time: String, #[prost(double, tag="28")] pub lot_volume: f64 }
            ...
            #[derive(Clone, PartialEq, ::prost::Message)] pub struct WebsocketChannel { #[prost(string, repeated, tag="1")] pub watchlist: Vec<String>, #[prost(string, repeated, tag="2")] pub order_book: Vec<String>, #[prost(string, repeated, tag="3")] pub running_trade: Vec<String>, #[prost(bool, tag="4")] pub is_hotlist: bool, #[prost(string, repeated, tag="5")] pub running_trade_batch: Vec<String>, #[prost(string, repeated, tag="6")] pub liveprice: Vec<String> }
            #[derive(Clone, PartialEq, ::prost::Message)] pub struct WebsocketRequest { #[prost(string, tag="1")] pub user_id: String, #[prost(message, optional, tag="2")] pub channel: Option<WebsocketChannel>, #[prost(string, tag="3")] pub key: String, #[prost(message, optional, tag="4")] pub ping: Option<PingRequest>, #[prost(string, tag="5")] pub access_token: String }
